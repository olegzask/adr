...
import "../../routes/remotestart/booking.styles.css";

export default function BookingTint({ opts }) {
  const { rem, partsToDo, reset,  dPrice, price} = opts;
    ...
    <div id="bookingForm" className="contactform-container booking-container">
      ...
      <form className="contact-form-main" ref={form} onSubmit={sendEmail}>
        ...
        <input
          ...
          type="number"
          name="phone"
          placeholder="Your phone number (No dashes)"
        />
        <div className="vehicle-info">
          ...
          />
            ...
            type="text"
            name="parts"
            value={`${ partsToDo.fronts? `Fronts: ${partsToDo.fronts}%` : ""}  ${ partsToDo.rears ? `Rears: ${partsToDo.rears}%` : ""} ${partsToDo.rearws ? `RearWindshield: ${partsToDo.rearws}%` : ""}  ${partsToDo.brow ? `Brow: ${partsToDo.brow}%` : ""} `}
          />
           ...
           <input
            ...
            type="text"
            name="estprice"
            value={`Estimated Price: $${price} + GST`}
          />
